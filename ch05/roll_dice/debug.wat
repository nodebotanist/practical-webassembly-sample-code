(module
 ...
 (memory $0 1)
 (data (i32.const 12) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00d\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data (i32.const 540) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 572) "|\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00^\00\00\00E\00l\00e\00m\00e\00n\00t\00 \00t\00y\00p\00e\00 \00m\00u\00s\00t\00 \00b\00e\00 \00n\00u\00l\00l\00a\00b\00l\00e\00 \00i\00f\00 \00a\00r\00r\00a\00y\00 \00i\00s\00 \00h\00o\00l\00e\00y\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 700) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00+\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 732) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d\00\00\00")
 (data (i32.const 796) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00(\00\00\00O\00b\00j\00e\00c\00t\00 \00i\00s\00 \00n\00o\00t\00 \00p\00i\00n\00n\00e\00d\00\00\00\00\00")
 (data (i32.const 864) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\t\00\00\02A\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $assembly/index/rollDie (param $dieMax i32) (result i32)
  (local $x f64)
 ...
 (func $assembly/index/readDiceInput (param $input i32) (result i32)
  (local $splitForDie i32)
  (local $splitForExtra i32)
  (local $value i32)
  (local $radix i32)
  (local $numberOfDice i32)
  (local $value|6 i32)
  (local $radix|7 i32)
  (local $numberOnDie i32)
  (local $extraAdd i32)
  (local $value|10 i32)
  (local $radix|11 i32)
  (local $12 i32)
  ...
  i32.const 10
  call $~lib/string/String#split
  local.tee $splitForDie
  i32.store $0 offset=8
  global.get $~lib/memory/__stack_pointer
  local.get $splitForDie
  local.set $14
  global.get $~lib/memory/__stack_pointer
  local.get $14
  i32.store $0 offset=12
  ...
  local.get $12
  i32.const 0
  local.get $numberOfDice
  call $~lib/array/Array<i32>#__set
  local.get $12
  i32.const 1
  local.get $numberOnDie
  call $~lib/array/Array<i32>#__set
  local.get $12
  i32.const 2
  local.get $extraAdd
 ...
 (func $assembly/index/rollDice (param $diceToRoll i32) (result i32)
  (local $numberOfDice i32)
  (local $numberOnDie i32)
  (local $extraAdd i32)
  (local $total i32)
 ...
 (func $assembly/index/roll (param $input i32) (result i32)
  (local $numbersToRoll i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  i32.store $0
  local.get $2
  call $assembly/index/readDiceInput
  local.tee $numbersToRoll
  i32.store $0 offset=4
  local.get $numbersToRoll
  local.set $2
  global.get $~lib/memory/__stack_pointer
  local.get $2
  i32.store $0
  local.get $2
  call $assembly/index/rollDice
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
